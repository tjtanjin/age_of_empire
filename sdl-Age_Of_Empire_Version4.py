...
def computerturn():
    ...
    while True:
        ...
        #computer hire option
            ...
            continue
    if cplayer.castle_health['castle_health'] == 0: #end game and print final player display if castle health is 0
        print("-----------Castle-----------")
        print("%r Castle Health: %r" % (cplayer.name, cplayer.castle_health['castle_health']))
        print("%r Castle Health: %r" % (nplayer.name, nplayer.castle_health['castle_health']))
        print("-----------Income-----------")
        ...
        print("----------------------------")
        return True
    elif cplayer.castle_health['castle_health'] > 0: #change turn if castle health is greater than 0
        return False
#-end function-
