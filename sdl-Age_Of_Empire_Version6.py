"""
Create a Turn Based Strategy Game "Age of Empire". The Egyptians and Greeks are at war!
...
class Empire():
    def __init__(self, name):
        ...
        self.castle = {'current_castle_health': 2000, 'max_castle_health': 2000} #castle properties
        self.gold = {'amount': 900} #current/starting gold (no max, increases by 100 every turn)
...
def controller(cplayer, nplayer, gamemode_choice):
    """
    Checks the value of playerturn() and computerturn() functions to regulate turns between player and player, player and AI or AI and AI.
    When false, the turn continues to alternate. When true, the game is won and end() function is called.
    Args:
        cplayer: current player
        nplayer: next player
        gamemode_choice: 1, 2 or 3 (Player VS Player / Player VS AI / AI VS AI)
    """
    while True:
        if gamemode_choice == 1:
            while playerturn(cplayer, nplayer) == True:
                break
            if cplayer.castle['current_castle_health'] == 0 or nplayer.castle['current_castle_health'] == 0:
...
def playerturn(cplayer, nplayer):
    ...
    print("-----------Castle-----------")
    print("%r Castle Health: %r" % (cplayer.name, cplayer.castle['current_castle_health']))
    print("%r Castle Health: %r" % (nplayer.name, nplayer.castle['current_castle_health']))
    print("-----------Income-----------")
    ...
    while True:
        ...
        #player repair option
            ...
            while True:
                ...
                if (cplayer_repair == "1" or cplayer_repair == "100") and cplayer.gold['amount'] >= 100: #repair 100 health
                    repair = 100
                    cplayer.castle['current_castle_health'] = cplayer.castle['current_castle_health'] + 100
                    ...
                    repair = 200
                    cplayer.castle['current_castle_health'] = cplayer.castle['current_castle_health'] + 200
                    ...
                    repair = 300
                    cplayer.castle['current_castle_health'] = cplayer.castle['current_castle_health'] + 300
        ...
        elif cplayer_choice == "3" or cplayer_choice == "H" and cplayer.gold < cplayer.soldier['price']:
    ...
    print("Knight(s): %r" % cplayer.knight['num'])
    print("----------------------------")
    #end of player's updated display
    if nplayer.castle['current_castle_health'] == 0: #end game if castle health is 0
        return True
    elif nplayer.castle['current_castle_health'] > 0: #change turn if castle health is greater than 0
        return False
...
def computerturn(cplayer, nplayer, gamemode_choice):
    ...
    if gamemode_choice == 3: #print AI's main display if in AI vs AI mode
        print("-----------Castle-----------")
        print("%r Castle Health: %r" % (nplayer.name, nplayer.castle['current_castle_health']))
        print("%r Castle Health: %r" % (cplayer.name, cplayer.castle['current_castle_health']))
        print("-----------Income-----------")
        ...
        print("----------------------------")
        #end of AI's main display, start of options
    print("The %r are considering their move..." % nplayer.name)
    time.sleep(3) #simulate loading time
    while True:
        #strength and health used to give the AI some "intelligence":
        #if castle health below 33% of max health, chances of AI repairing is higher
        ...
        if nplayer.soldier['attack'] * nplayer.soldier['num'] + nplayer.warrior['attack'] * nplayer.warrior['num'] + nplayer.knight['attack'] * nplayer.knight['num'] > 320:
            ...
            strength = 5
        if nplayer.castle['current_castle_health'] > nplayer.castle['max_castle_health']//3:
            health = 1
        else:
            health = 0
        ...
        if nplayer_choice == 2 or nplayer_choice == 3:
            ...
            if luck < 8:
                cplayer.castle['current_castle_health'] = cplayer.castle['current_castle_health'] - nplayer_attack_strength
                if cplayer.castle['current_castle_health'] < 0: #ensure castle health cannot be negative
        ...
        #computer repair option
        elif (nplayer_choice == 1 and nplayer.gold['amount'] >= 100 and nplayer.castle['current_castle_health'] < nplayer.castle['max_castle_health']) or (nplayer_choice == 0 and nplayer.gold['amount'] >= 100 and nplayer.castle['current_castle_health'] < nplayer.castle['max_castle_health']): #ensure enough gold for minimal repair and no repair when health is full
            while True:
                ...
                if nplayer_repair == 1 and nplayer.gold['amount'] >= 100: #repair 100 health
                    repair = 100
                    nplayer.castle['current_castle_health'] = nplayer.castle['current_castle_health'] + 100
                    ...
                    repair = 200
                    nplayer.castle['current_castle_health'] = nplayer.castle['current_castle_health'] + 200
                    ...
                    repair = 300
                    nplayer.castle['current_castle_health'] = nplayer.castle['current_castle_health'] + 300
                    nplayer.gold['amount'] = nplayer.gold['amount'] - 300 #subtract 300 gold
                    break
                else:
                    continue
            if nplayer.castle['current_castle_health'] > nplayer.castle['max_castle_health']: #ensure castle health does not exceed max health, set castle health to max and refund gold if so
                gold_refund = nplayer.castle['current_castle_health'] - nplayer.castle['max_castle_health']
            ...
            elif nplayer.castle['current_castle_health'] <= nplayer.castle['max_castle_health']:
                print("%r repairing Castle..." % nplayer.name)
                time.sleep(5) #simulate loading time
                print("The %r Castle has repaired %r health!" % (nplayer.name, repair))
            break
        #computer hire option
        elif (nplayer_choice == 4 and nplayer.gold['amount'] >= 5*nplayer.soldier['price']) or (nplayer_choice == 5 and nplayer.gold['amount'] >= 5*nplayer.soldier['price']) : #ensure enough gold for minimal hire of 100 gold worth of soldiers (purposely to make AI hire more)
            while True:
            ...
            continue
    if cplayer.castle['current_castle_health'] == 0 and (gamemode_choice == 2): #end game and print final player display if castle health is 0 (player vs AI mode)
        print("-----------Castle-----------")
        print("%r Castle Health: %r" % (cplayer.name, cplayer.castle['current_castle_health']))
        print("%r Castle Health: %r" % (nplayer.name, nplayer.castle['current_castle_health']))
        print("-----------Income-----------")
        ...
        print("----------------------------")
        return True
    elif cplayer.castle['current_castle_health'] > 0 and (gamemode_choice == 2): #change turn if castle health greater than 0
        return False
    elif cplayer.castle['current_castle_health'] == 0 and (gamemode_choice == 3): #end game and print final AI display if castle health greater is 0 (AI vs AI mode)
        print("-----------Castle-----------")
        print("%r Castle Health: %r" % (nplayer.name, nplayer.castle['current_castle_health']))
        print("%r Castle Health: %r" % (cplayer.name, cplayer.castle['current_castle_health']))
        print("-----------Income-----------")
        ...
        print("----------------------------")
        return True
    elif cplayer.castle['current_castle_health'] > 0 and (gamemode_choice == 3): #change turn and print final AI display if castle health greater than 0 (AI vs AI mode)
        #at the end of an executed decision, print updated player display and call up next player's turn
        print("-----------Castle-----------")
        print("%r Castle Health: %r" % (nplayer.name, nplayer.castle['current_castle_health']))
        print("%r Castle Health: %r" % (cplayer.name, cplayer.castle['current_castle_health']))
...
def end(cplayer, nplayer, gamemode_choice):
    ...
    Args:
        cplayer: current player
        nplayer: next player
        gamemode_choice: 1, 2 o3 3 (Player VS Player / Player VS AI / AI VS AI)
    """
    if gamemode_choice == 1 and cplayer.castle['current_castle_health'] == 0: #if player vs player and Greeks won
        print("The Greeks are Victorious!")
    if gamemode_choice == 1 and nplayer.castle['current_castle_health'] == 0: #if player vs player and Egyptians won
        print("The Egyptians are Victorious!")
    if gamemode_choice == 2 and cplayer.castle['current_castle_health'] == 0: #if player vs AI and AI won
        print("The Greeks are Victorious!")
    if gamemode_choice == 2 and nplayer.castle['current_castle_health'] == 0: #if player vs AI and player won
        print("The Egyptians are Victorious!")
    if gamemode_choice == 3 and cplayer.castle['current_castle_health'] == 0: #if AI vs AI and Greek won
        print("The Greeks are Victorious!")
    if gamemode_choice == 3 and nplayer.castle['current_castle_health'] == 0: #if AI vs AI and Egyptian won
        print("The Egyptians are Victorious!")
    print("----------------------------")
    while True:
...
print("""                    
                 ...
                 |____ |  \/  | |     __|__ |   \ |____ .
""") 
print("In this game, The Egyptians and Greeks are having an all out war!\nFor a start, may we know your name?")
...
def start():
    #set to default all values
    cplayer.castle['max_castle_health'] = 2000
    cplayer.castle['current_castle_health'] = cplayer.castle['max_castle_health']
    ...
    while True:
        ...
        if gamemode_choice == "1": #player vs player
            ...
            print("How strong are you?\n1. Prince \n2. King \n3. God \n4. Titan")
            while True:
                gamemode_difficulty = input("> ").upper()
                if gamemode_difficulty == "1" or gamemode_difficulty == "P":
                    nplayer.castle['max_castle_health'] = 2000
                    nplayer.castle['current_castle_health'] = 2000
                    nplayer.gold['amount'] = 900
                    nplayer.soldier['num'] = 30
                    nplayer.soldier['attack'] = 5
                    nplayer.warrior['num'] = 15
                    ...
                    nplayer.knight['attack'] = 20
                    break
                if gamemode_difficulty == "2" or gamemode_difficulty == "K":
                    nplayer.castle['max_castle_health'] = 2500
                    nplayer.castle['current_castle_health'] = 2500
                    nplayer.gold['amount'] = 1900
                    nplayer.soldier['num'] = 30
                    nplayer.soldier['attack'] = 7
                    nplayer.warrior['num'] = 15
                    nplayer.warrior['attack'] = 12
                    nplayer.knight['num'] = 5
                    nplayer.knight['attack'] = 22
                    break
                if gamemode_difficulty == "3" or gamemode_difficulty == "G":
                    nplayer.castle['max_castle_health'] = 3000
                    nplayer.castle['current_castle_health'] = 3000
                    nplayer.gold['amount'] = 2900
                    nplayer.soldier['num'] = 30
                    nplayer.soldier['attack'] = 7
                    nplayer.warrior['num'] = 20
                    nplayer.warrior['attack'] = 12
                    nplayer.knight['num'] = 7
                    nplayer.knight['attack'] = 22
                    break
                if gamemode_difficulty == "4" or gamemode_difficulty == "T":
                    nplayer.castle['max_castle_health'] = 4000
                    nplayer.castle['current_castle_health'] = 4000
                    nplayer.gold['amount'] = 3900
                    nplayer.soldier['num'] = 31
                    nplayer.soldier['attack'] = 9
                    nplayer.warrior['num'] = 20
                    nplayer.warrior['attack'] = 13
                    nplayer.knight['num'] = 7
                    nplayer.knight['attack'] = 23
                    break
